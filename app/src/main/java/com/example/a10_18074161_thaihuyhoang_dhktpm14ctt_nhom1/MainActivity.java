package com.example.a10_18074161_thaihuyhoang_dhktpm14ctt_nhom1;
...
//                Toast.makeText(MainActivity.this, "tai khoan mat khau khong hop le", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        try {
            ...
            ApiGmail.apiService.addGmail(new Gmail(personName, personEmail, date+"")).enqueue(new Callback<Gmail>() {
                ...
                public void onResponse(Call<Gmail> call, Response<Gmail> response) {
                    Toast.makeText(MainActivity.this, "addSuccess gmail", Toast.LENGTH_SHORT).show();
                }
